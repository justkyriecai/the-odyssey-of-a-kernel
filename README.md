...
**[Read the tech report →](workspace/transformer-forward-opt/docs/tech-report.md)** · **[Explore the website →](https://claude.ai/code/artifact/62c1b102-89ac-4e52-9aa2-b4c19224acd6)**
...
Behind the numbers: 387 recorded measurements and a 19-node search DAG, every
wrong turn included. The full story -- environment, optimizations, final
results -- is the
[**tech report**](workspace/transformer-forward-opt/docs/tech-report.md);
